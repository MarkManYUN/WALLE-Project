...
namespace WalleProject.Web
{
    public class Global : System.Web.HttpApplication
    {
        ...
        protected void Application_Start(object sender, EventArgs e)
        {
            ...
            #endregion
            WalleProject.Web.Code.SubMenu.ReWriteApplication();
        }
        ...
        protected void Session_Start(object sender, EventArgs e)
        {
            ...
            Session["Imginfomation"] = new string[3];
            //Session["informationimgs"] = new Image();
            Session["UploadImgs"] = new HttpPostedFile[30];
        ...
        {
            Response.Redirect("../Background/Error/500.html");
        }
