<%@ Page Title="" Language="C#" MasterPageFile="~/User/User.Master" AutoEventWireup="true" CodeBehind="RecyclingCar.aspx.cs" Inherits="WalleProject.Web.User.RecyclingCar" %>
                                    ...
                                    <div class="col-md-10">
                                        ...
                                        <div class="row">
                                            <blockquote class="blockquote-reverse">
                                               ...
                                               <p class="text-left text-success"> 联系方式：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                    <%#Eval("add_contactName") %>&nbsp;&nbsp;&nbsp;  <%#Eval("add_contactPhone") %>  </p>
                                        <a href='RecyclingCar.aspx?rid= <%#Eval("tra_ID") %>' style="color:#ff0000">取消订单</a>   
...
inner join t_wastesmailcate on t_waste.was_cate_ID=t_wastesmailcate.wastecate_id
  ...
  WHERE   tra_U_ID  = ?  and  tra_type='废品' ORDER BY  tra_transactionDate  DESC">
                    <SelectParameters>
