<%@ Page Title="" Language="C#" MasterPageFile="~/StaffSystem/StaffSystem.Master" AutoEventWireup="true" CodeBehind="WastePhoto.aspx.cs" Inherits="WalleProject.Web.StaffSystem.WastePhoto" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="TitleHolder" runat="server">废品图片库
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="navHolder" runat="server">废品图片列表
</asp:Content>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
           <asp:ListView ID="ListView1" ItemPlaceholderID="holder" runat="server" DataSourceID="SqlDataSource1">
                ...
                <ItemTemplate>
                        <a href='WastePhotoAdd.aspx?wid=<%#Eval("pic_ID")%>' style="">
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:walledbConnectionString %>"
                ...
                SelectCommand="select pic_cate_ID,pic_ID,pic_date,pic_name,pic_valid from t_picture where pic_cate_ID=4"></asp:SqlDataSource>
        </ContentTemplate>
        <Triggers>
