<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeBehind="NewsEdit.aspx.cs" Inherits="WalleProject.Web.StaffSystem.NewsEdit" %>
            ...
            <div class="col-lg-4" style="">
                ...
                <table style="width: 100%;" cellpadding="2" cellspacing="1" class="border">
                            ...
                            <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                ...
                                <tr>
                                    ...
                                    <td height="25" width="*" align="left">
                                        <asp:TextBox ID="txtEditnew_title" TextMode="MultiLine" placeholder="新闻标题" CssClass="form-control" runat="server" Width="200px"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td height="25" width="30%" align="right"></td>
                                    <td height="25" width="*" align="left">
                                        <asp:DropDownList runat="server" Width="200px" placeholder="新闻类型" CssClass="form-control" ID="txtEditnew_cate_id"
                                            DataTextField="newc_name" DataValueField="newc_ID" DataSourceID="SqlDataSource1"></asp:DropDownList>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <img alt="新闻名" class=" img-rounded" id="img_i_mo" runat="server"  data-src="holder.js/64x64"
                                            style="max-width: 150px; margin: 1%;" src="#" />
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td height="25" width="30%" align="right"></td>
                                    <td height="25" width="*" align="left">
                                        <asp:TextBox ID="txtEditnew_valid" TextMode="MultiLine" placeholder="新闻简述" CssClass="form-control" runat="server" Width="200px"></asp:TextBox>
                                    </td>
                                </tr>
                            </table> 
                        </td>
                    ...
                    <tr>
                     ...
                     <tr>
                        <td height="25" width="*" align="left">
                            新闻编号：<asp:Label ID="Label1" runat="server"></asp:Label>
                            <asp:Label ID="imgID" runat="server" Style="display:none;"></asp:Label>
                        </td>
                    </tr>
                </table>
                <br />
            ...
            <div class="col-lg-8" style="">
                ...
                <p class="tdbg" align="center" valign="bottom">
                    <asp:Button ID="btnSave" runat="server" Text="保存"
                        OnClick="btnEditSave_Click" class="btn btn-info"></asp:Button>
