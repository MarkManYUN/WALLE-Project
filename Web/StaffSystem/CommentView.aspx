<%@ Page Title="" Language="C#" MasterPageFile="~/StaffSystem/StaffSystem.Master" AutoEventWireup="true" CodeBehind="CommentView.aspx.cs" Inherits="WalleProject.Web.StaffSystem.CommentView" %>
...
<asp:Content ContentPlaceHolderID="navHolder" ID="content7" runat="server">评论我的订单</asp:Content>
...
<asp:Content ID="Content5" ContentPlaceHolderID="JavaScriptHolder" runat="server">
    <script src="../User/starjs/jquery.star.js"></script>
    <link href="../User/starjs/jquery.star.min.css" rel="stylesheet" />
    <script src="../User/starjs/jquery.star.min.js"></script>
