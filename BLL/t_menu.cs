...
namespace WalleProject.BLL
{
	...
	{
		private readonly WalleProject.DAL.t_menu dal=new WalleProject.DAL.t_menu();
		public t_menu()
		{}
		#region  BasicMethod
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public WalleProject.Model.t_menu GetModelByCache(int menu_ID)
		{
			
			string CacheKey = "t_menuModel-" + menu_ID;
			...
			return (WalleProject.Model.t_menu)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<WalleProject.Model.t_menu> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<WalleProject.Model.t_menu> DataTableToList(DataTable dt)
		{
			List<WalleProject.Model.t_menu> modelList = new List<WalleProject.Model.t_menu>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				WalleProject.Model.t_menu model;
