...
namespace WalleProject.BLL
{
    ...
    {
        private readonly WalleProject.DAL.t_staffsalary dal = new WalleProject.DAL.t_staffsalary();
        ...
        /// 得到一个对象实体，从缓存中
        /// </summary>
        public WalleProject.Model.t_staffsalary GetModelByCache(int sal_ID)
        {

            string CacheKey = "t_staffsalaryModel-" + sal_ID;
            ...
            return (WalleProject.Model.t_staffsalary)objModel;
        }
        ...
        /// 获得数据列表
        /// </summary>
        public List<WalleProject.Model.t_staffsalary> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<WalleProject.Model.t_staffsalary> DataTableToList(DataTable dt)
        {
            List<WalleProject.Model.t_staffsalary> modelList = new List<WalleProject.Model.t_staffsalary>();
