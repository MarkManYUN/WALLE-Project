...
namespace WalleProject.DAL
{
    ...
    public partial class t_wastecategory
    {
        ...
        public int GetMaxId()
        {
            return DbHelperMySQL.GetMaxID("wasc_ID", "t_wastecategory");
        }
        ...
        public bool Exists(int wasc_ID)
        {
            ...
            strSql.Append("select count(1) from t_wastecategory");
        ...
        public bool Delete(int wasc_ID)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from t_wastecategory ");
            strSql.Append(" where wasc_ID=@wasc_ID");
            MySqlParameter[] parameters = {
                    new MySqlParameter("@wasc_ID", MySqlDbType.Int32)
            };
        ...
        public bool DeleteList(string wasc_IDlist)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from t_wastecategory ");
            strSql.Append(" where wasc_ID in (" + wasc_IDlist + ")  ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select wasc_name,wasc_ID,wasc_c_id ");
            strSql.Append(" FROM t_wastecategory ");
            if (strWhere.Trim() != "")
            {
        ...
        public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
        {
            ...
            {
                strSql.Append("order by T.wasc_ID desc");
            }
            strSql.Append(")AS Row, T.*  from t_wastecategory T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "t_wastecategory";
			parameters[1].Value = "wasc_ID";
